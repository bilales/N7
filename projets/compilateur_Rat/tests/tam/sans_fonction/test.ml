...
let%expect_test "testTableau1" =
  runtam (pathFichiersRat^"testTableau1.rat");
  [%expect{| [3/4][13/36] |}]

let%expect_test "testTableau2" =
  runtam (pathFichiersRat^"testTableau2.rat");
  [%expect{| false |}]

let%expect_test "testTableau3" =
  runtam (pathFichiersRat^"testTableau3.rat");
  [%expect{| 1020304050 |}]
