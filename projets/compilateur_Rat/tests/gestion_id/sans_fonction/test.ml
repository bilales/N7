...
let%test_unit "testTableau1" = 
let _ = compiler (pathFichiersRat^"testTableau1.rat") in ()

let%test_unit "testTableau2" =
  let _ = compiler (pathFichiersRat^"testTableau2.rat") in ()

let%test_unit "testTableau3" =
let _ = compiler (pathFichiersRat^"testTableau3.rat") in ()
...
let%test_unit "testGoto2DoubleDeclaration" = 
  try 
    let _ = compiler (pathFichiersRat^"testGoto2DoubleDeclaration.rat")
    in raise ErreurNonDetectee
  with
  | DoubleDeclaration("x") -> ()  
