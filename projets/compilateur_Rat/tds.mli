...
type info =
  (* Information associée à une constante : son nom et sa valeur *)
  | InfoConst of string * int
  (* Information associée à une variable : son nom, son type, et son adresse ie son déplacement (int) par rapport à un registre (string) *)
  | InfoVar of string * typ * int * string
  (* Information associée à une fonction : son nom , son type de retour et la liste des types des paramètres *)
  | InfoFun of string * typ * typ list
  |InfoGoto of string * typ * int * string
...
(* Renvoie la taille associée*)
val getTailleTds : info_ast -> int
