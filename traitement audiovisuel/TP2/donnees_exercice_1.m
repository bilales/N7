...
figure('Name','Images de pensees',...
       'Position',[0.02*L,0.1*H,0.3*L,0.7*H],'Color',[0.7 0.75 0.85]);
for i = 1:nb_pensees
...
figure('Name','Images d''oeillets',...
       'Position',[0.35*L,0.1*H,0.3*L,0.7*H],'Color',[0.7 0.75 0.85]);
for i = 1:nb_oeillets
	subplot(nb_lignes_affichage,nb_colonnes_affichage,i);
...
figure('Name','Images de chrysanthemes',...
       'Position',[0.68*L,0.1*H,0.3*L,0.7*H],'Color',[0.7 0.75 0.85]);
